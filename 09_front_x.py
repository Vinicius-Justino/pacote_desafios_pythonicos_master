...
def front_x(words):
    # +++ SUA SOLUÇÃO +++
    palavras_x = [palavra for palavra in words if palavra[0] == "x"]
    palavras = [palavra for palavra in words if palavra not in palavras_x]

    return sorted(palavras_x) + sorted(palavras)
